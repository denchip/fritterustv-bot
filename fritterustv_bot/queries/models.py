...
class Query(models.Model):
    ...
    description = models.CharField(max_length=255, verbose_name='Описание (если запрос без текста)')
    description_pattern = models.CharField(max_length=255, verbose_name='Шаблон описания')
